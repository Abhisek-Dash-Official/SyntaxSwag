...
export default function Deskwares() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        url.searchParams.append("type", "deskwares");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Hero */}
        <div className="text-center mb-12 flex justify-between items-center flex-wrap">
          <div className="">
            ...
            <p className="text-gray-600 text-lg md:text-xl max-w-2xl mx-auto">
              Upgrade your workspace with our finest selection of premium
              deskwares
            </p>
          </div>
          <button
      ...
      {isOpenFilter ? (
        <Filter
          close={closeFilter}
          colors={{
            colorsArr: ["red", "green", "blue", "yellow", "black"],
            colorsFunc: (colors) => {
              setColors(colors);
            },
          }}
          ...
          category={{
            categoryArr: ["deskmats", "mugs", "mousepads"],
